const navigation = {
  social: [
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/karsyz/',
      icon: (props) => (
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/channel/UC-i2dKXx5tprUjrpeX90mQg',
      icon: (props) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/in/mattkars/',
      icon: (props) => (
        <svg 
          height="20" 
          viewBox="0 0 72 72" 
      ...
      <div className="mx-auto px-6 pb-8 lg:px-8">
        <div className="pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">
            &copy; 2024 Matt Kars. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
