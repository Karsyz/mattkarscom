...
const NewsletterLatestPrev = () => {
  ...
  return (
    <section id="newsletter" className="bg-white pt-10 sm:px-32 w-full">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">

        <div className="max-w-2xl">
          <div className="flex gap-2 items-center tracking-tight">
            <div className="h-8 w-8 rounded-sm bg-red-500" />
            <h3 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Karsyz Linked List {date}</h3>
