const Hero = () => {
  return (
    ...
    <div className="relative text-right font-bold text-slate-800 leading-tight px-8 backface-hidden -rotate-y-45 select-none mr-48 mt-16 perspective-origin-center">
